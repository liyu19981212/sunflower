			...
			$.ajax({
					...
					success: function (result) {
						...
						if(result.Status="ok"){
							...
							$('#mytab').bootstrapTable('refresh', {url: '/admin/getStudentList'});
